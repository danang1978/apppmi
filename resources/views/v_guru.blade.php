...
<table class="table table-bordered">
    ...
    @foreach ($guru as $data)
        <tr>
            ...
            <td>
                <a href="/guru/detail/{{ $data->id_guru }}" class="btn btn btn-success">Detail</a>
                <a href="/guru/edit/{{ $data->id_guru }}" class="btn btn btn-warning">Edit</a>
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete{{ $data->id_guru }}">Delete</button>
            </td>
        </tr>
        @endforeach
    </tbody>
